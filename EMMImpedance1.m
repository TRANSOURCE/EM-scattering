function [EM,NEM,E,ConditionA,NormA] = EMMImpedance(a,d,M)
%DESCRIPTION: Solving electromagnetic scattering problem in 3D with M
%impedance particles
%SYNTAX     : [EM,NEM,E,ConditionA,NormA] = EMMImpedance(a,d,M)
%INPUT      : a   : The radius of particles 
%             d   : distance between neigboring particles
%             M   : Number of particles (Number of equations and unknows)
%OUTPUT     : EM  : The solution to the scattering problem in vector form (x,y,z)
%             NEM : Norm of EM
%             E   : Error of the solution 
%             ConditionA: Condition of the main matrix
%             NormA     : Norm of the main matrix
...
printInputs(c,w,k,kappa,Domain,a,d,M,alpha,ES,N,h,mu);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function Err = Error()
        %Err = (1/PI4)*max([a/d^3 a*k^2/d a*k/d^2],[],2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function printInputs(c,f,k,kappa,VolQ,a,d,M,alpha,ES,N,h,mu)
        ...
        str = strcat(str, sprintf('\nThe smallest distance between neighboring particles, d = O(1/M^(1/3)): %e',d));
